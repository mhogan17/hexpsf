...
class HexPSF:
    ...
    def intensity(self, x0, y0, zp, wl, N, B, corrections, z_modes):
        self.set_corrections(corrections=corrections)
    ...
    def show(self):
        ...
        axs[1].imshow(add_noise(self.intensity(x0=0, y0=0, zp=0, wl=0.513, N=2500, B=10, corrections=[0,0,0], z_modes=[])))
        axs[2].imshow(add_noise(self.intensity(x0=0, y0=0, zp=0, wl=0.579, N=25000, B=10, corrections=[0,0,0], z_modes=[])))
        axs[3].imshow(add_noise(self.intensity(x0=0, y0=0, zp=0, wl=0.683, N=2500, B=10, corrections=[0,0,0], z_modes=[])))
...
# psf.optics.delta_t = 1.5
# psf.optics.delta_z = 1.5
#
# plt.imshow(psf.intensity(0, 0, 0.05, 0.54, 25000, 100, corrections=[0,0,0], z_modes=[]))
# plt.show()
#
# for dt in range(20):
#     fig = plt.figure()
#     psf.optics.delta_t = dt / 20
#     ax = fig.add_subplot(211)
#     ax.imshow(psf.intensity(0, 0, 0, 0.513, 25000, 100, corrections=[0,0,0], z_modes=[]))
#
#     psf.optics.delta_t = - dt / 20
